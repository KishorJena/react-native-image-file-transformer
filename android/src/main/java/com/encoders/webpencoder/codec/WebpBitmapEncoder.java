package com.encoders.webpencoder.codec;
...
import com.encoders.webpencoder.io.WebpContainerWriter;
import com.encoders.webpencoder.stream.FileSeekableOutputStream;
import com.encoders.webpencoder.stream.SeekableOutputStream;
import com.encoders.webpencoder.utils.Logs;
import com.encoders.webpencoder.webpProcess.WebpMuxer;
...
public class WebpBitmapEncoder {
    ...
    public WebpBitmapEncoder(File file) throws FileNotFoundException {
        ...
        _writer = new WebpContainerWriter((SeekableOutputStream) _outputStream);
